...
Subcategory.create(subcategory_name:"flask")
Subcategory.create(subcategory_name:"tube")
Subcategory.create(subcategory_name:"burettes")
Subcategory.create(subcategory_name:"cylinders")
